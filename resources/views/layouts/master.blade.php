...
<title>CÔNG TY TNHH ẤN LĨNH</title>
...
<!-- Menu -->
    ...
    <div id="menutop" style="background:#468264">
         ...
         <div class="menutopletf">
            <div id="menu">
                <ul class="sf-menu">
                <li class="current"><a style="text-transform:uppercase; color:#FFFF00" href="http://alicohue.com">TRANG CHỦ</a></li>
                
                <li><a style="text-transform:uppercase; color:#FFFF00" href="http://alicohue.com/gioithieu.asp">GIỚI THIỆU</a></li>
            ...
            <!-- tim nhom lon san pham -->
                ...
                <li><a style="text-transform:uppercase; color:#FFFF00" href="http://alicohue.com/hoso.asp">HỒ SƠ CÔNG TY</a></li>
                
                <li><a style="text-transform:uppercase; color:#FFFF00" href="http://alicohue.com/lienhe.asp">LIÊN HỆ</a></li>
      ...
      <!-- -menu ngang -->
        <div id="contentsectionleft">
            ...
            <div class="linetilte"></div>
             ...
             <div class="contact">
              <div style="height:89px"><img class="contact_img" src="http://alicohue.com/img_contact/default_contact_photo.gif" /></div>
                <div class="contact_name"></div>
                <div class="contact_chucvu">
        
                - <span style="color:#2194d2"></span>
